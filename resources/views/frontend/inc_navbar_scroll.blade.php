            ...
            <div class="row  justify-content-between">
                ...
                <!-- non-login-->
                    <ul class="nav-list">
                        ...
                        <li class="nav-link scroll"><a href="{{url('tourist_attraction')}}">Tourist Attraction</a></li>
                        <li class="nav-link scroll">
                            <div class="dropdown profile">
                                <button class="btn btn-lang dropdown-toggle"><i class="fas fa-user-circle name-text me-2 text-orange"></i>Welcome,@if(Auth::user()!=null) {{Auth::user()->firstname}} @else Elle @endif</button>
                        ...
                        <li class="nav-link scroll"><a href="{{url('signin')}}"><i class="fas fa-sign-in-alt text-orange pe-2"></i>Sign in</a></li>
                        @endif
                ...
                <!-- when-login-->
                    <!--<ul class="nav-list">
                        ...
                        <li class="nav-link scroll"><a href="tourist_attraction.php">Tourist Attraction</a></li>
