    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="row g-1">
                ...
                <div class="col-sm-5">
                    <div class="img-b">
                    <img src="{{asset('assets_frontend/images/room%20(2).jpg')}}" style="width:100%" data-bs-toggle="modal" data-bs-target="#popup-img-head">
                    </div>
                    <div class="row g-2" >
                        <div class="col-6">
                            <div class="img-c">
                                <img src="{{asset('assets_frontend/images/room%20(3).jpg')}}" style="width:100%" data-bs-toggle="modal" data-bs-target="#popup-img-head">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="img-c text-on">
                                <img src="{{asset('assets_frontend/images/rooma%20(1).jpg')}}" style="width:100%" class="img-see-more"  data-bs-toggle="modal" data-bs-target="#popup-img-head">
                    ...
                    <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false" data-bs-interval="false">
                      <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                          <img src="{{asset('assets_frontend/images/room%20(2).jpg')}}" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                          <img src="{{asset('assets_frontend/images/room%20(3).jpg')}}" class="d-block w-100" alt="...">
                        </div>
                          <div class="carousel-item">
                          <img src="{{asset('assets_frontend/images/rooma%20(1).jpg')}}" class="d-block w-100" alt="...">
                        </div>
                          <div class="carousel-item">
                          <img src="{{asset('assets_frontend/images/rooma%20(2).jpg')}}" class="d-block w-100" alt="...">
                        </div>
                          <div class="carousel-item">
                          <img src="{{asset('assets_frontend/images/rooma%20(3).jpg')}}" class="d-block w-100" alt="...">
                        </div>
                          <div class="carousel-item">
                          <img src="{{asset('assets_frontend/images/roomb%20(1).jpg')}}" class="d-block w-100" alt="...">
                        </div>
                          <div class="carousel-item">
                          <img src="{{asset('assets_frontend/images/roomb%20(2).jpg')}}" class="d-block w-100" alt="...">
                        </div>
                      </div>
            ...
            <div class="box-white">
                ...
                <div class="vl-top-book">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6"><div class="text-tiny text-light-grey mt-1 text-end" >100m.</div></div>
                    </div>
                    <div class="row">
                        <div class="col-6">
                             <div class="text-tiny text-light-grey mt-1">location</div>
        ...
        <div class="box-white">
            <div class="mt-2">
                ...
                <div class="box-grey my-2">
                    ...
                    <div class="row g-2">
                        <div class="col-sm-3">
                            <img src="{{asset('assets_frontend/images/rooma%20(1).jpg')}}" style="width:100%" data-bs-toggle="modal" data-bs-target="#popup-img-room1">
                            <div class="row g-2 mt-1">
                                <div class="col-6">
                                    <img src="{{asset('assets_frontend/images/rooma%20(2).jpg')}}" style="width:100%" data-bs-toggle="modal" data-bs-target="#popup-img-room1" >
                                </div>
                                <div class="col-6">
                                    <img src="{{asset('assets_frontend/images/rooma%20(3).jpg')}} " style="width:100%" data-bs-toggle="modal" data-bs-target="#popup-img-room1">
                                </div>
                            </div>
            ...
            <div class="modal fade" id="popup-img-room1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div id="carousel-room1" class="carousel slide" data-bs-touch="false" data-bs-interval="false">
                      <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                          ...
                          <div class="carousel-item">
                          <img src="{{asset('assets_frontend/images/rooma%20(4).jpg')}}" class="d-block w-100" alt="...">
                        </div>
                      </div>
                        ...
                        <div class="col-sm-9">
                            <div class="none-mobile">
                                <div class="row g-1 ">
                                    <div class="col-sm-6">
                                        <div class="row g-1">
                                            <div class="col-7"><div class="text-tiny text-bold text-grey">Benefit</div></div>
                                            <div class="col-5"><div class="text-tiny text-bold text-grey">Sleep</div></div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="row g-1">
                                            <div class="col-4"><div class="text-tiny text-bold text-grey">Price per night</div></div>
                                            <div class="col-2"><div class="text-tiny text-bold text-grey">Rooms</div></div>
                                            <div class="col-6"></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-1">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="row g-1">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="vl-left facility">
                                                            <a href="{{url('booking-1')}}" class="btn-book">Book now</a>
                                                        </div>    
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="collapseOne1" class="accordion-collapse collapse show" aria-labelledby="headingOne1" data-bs-parent="#accordionExample">
                                          <div class="accordion-body">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-sm-6">
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/hair-dryer.png')}}" class="icon-facility me-2">Hair dryer</div>
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/bath-tub.png')}}" class="icon-facility me-2">Bathtub</div>
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/towel.png')}}" class="icon-facility me-2">Towels</div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/skincare.png')}}" class="icon-facility me-2">Toiletries</div>
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/shower.png')}}" class="icon-facility me-2">Shower</div>
                                                    </div>
                                                </div>
                                                <div class="text-tiny text-bold text-grey  mt-2">Entertainment</div>
                                                <div class="row g-2">
                                                    <div class="col-sm-6">
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/television.png')}}" class="icon-facility me-2">TV</div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/wifi.png')}}" class="icon-facility me-2">Free Wi-Fi</div>
                                                    </div>
                                                </div>
                                                <div class="text-tiny text-bold text-grey  mt-2">Comforts</div>
                                                <div class="row g-2">
                                                    <div class="col-sm-6">
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/air-conditioner.png')}}" class="icon-facility me-2">Air conditioner</div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/alarm-clock.png')}}" class="icon-facility me-2">Alarm clock</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-sm-6">
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/water-drop.png')}}" class="icon-facility me-2">Free bottle water</div>
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/coffee-cup.png')}}" class="icon-facility me-2">Complimentary tea</div>

                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/refrigerator.png')}}" class="icon-facility me-2">Refrigerator</div>
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/oven.png')}}" class="icon-facility me-2">Kitchen</div>
                                                    </div>
                                                </div>
                                                <div class="text-tiny text-bold text-grey  mt-2">Layout and furnishings</div>
                                                <div class="row g-2">
                                                    <div class="col-sm-6">
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/desk-chair.png')}}" class="icon-facility me-2">Desk</div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/sofa.png')}}" class="icon-facility me-2">Seating area</div>
                                                    </div>
                                                </div>
                                                <div class="text-tiny text-bold text-grey  mt-2">Clothing and laundry</div>
                                                <div class="row g-2">
                                                    <div class="col-sm-6">
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/closet.png')}}" class="icon-facility me-2">Closet</div>
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/iron.png')}}" class="icon-facility me-2">Ironing facilies</div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/hanger.png')}}" class="icon-facility me-2">Clothes rack</div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-sm-6">
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/safe-box.png')}}" class="icon-facility me-2">In-rooms safe box</div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="text-small text-light-grey my-1"><img src="{{asset('assets_frontend/images/first-aid-kit.png')}}" class="icon-facility me-2">Firts-aid kit</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="box-grey my-2">
                    ...
                    <div class="row g-2">
                        <div class="col-sm-3">
                            <img src="{{asset('assets_frontend/images/roomb%20(3).jpg')}}" style="width:100%" data-bs-toggle="modal" data-bs-target="#popup-img-room2">
                            <div class="row g-2 mt-1">
                                <div class="col-6">
                                    <img src="{{asset('assets_frontend/images/roomb%20(2).jpg')}}" style="width:100%" data-bs-toggle="modal" data-bs-target="#popup-img-room2">
                                </div>
                                <div class="col-6">
                                    <img src="{{asset('assets_frontend/images/roomb%20(4).jpg')}}" style="width:100%" data-bs-toggle="modal" data-bs-target="#popup-img-room2">
                                </div>
                            </div>
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content popup-img">
                    ...
                    <div id="carousel-room2" class="carousel slide" data-bs-touch="false" data-bs-interval="false">
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="{{asset('assets_frontend/images/roomb%20(3).jpg')}}" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                          <img src="{{asset('assets_frontend/images/rooma%20(2).jpg')}}" class="d-block w-100" alt="...">
                        </div>
                        ...
                        <div class="carousel-item">
                          <img src="{{asset('assets_frontend/images/roomb%20(4).jpg')}}" class="d-block w-100" alt="...">
                        </div>
                      </div>
            ...
            <div class="clearfix mt-2">
                <div class="float-end">
                    <a href="{{url('review_hotel')}}" class="btn-line-orange">Read all reviews</a>                    
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-sm-6">
                    <img src="{{asset('assets_frontend/images/room%20(3).jpg')}}" class="w-100">
                </div>
                <div class="col-sm-6">
            ...
            <div class="">
                  <div class="owl-carousel slide-carousel owl-theme  recommend">
                      <a class="" href="{{url('select-rooms')}}" >
                          <div class="card" >
                              <div class="img-rec">
                              <img src="{{asset('assets_frontend/images/recomment%20(1).jpg')}}" class="card-img-top" alt="...">
                              </div>
                              <div class="card-body">
                      ...
                      <a class="" href="{{url('select-rooms')}}" >
                          <div class="card" >
                               <div class="img-rec">
                              <img src="{{asset('assets_frontend/images/recomment%20(2).jpg')}}" class="card-img-top" alt="...">
                              </div>
                              <div class="card-body">
                                  <p class="name-text">poolvilla</p>
                                  <p class="detail-text">cities , country</p>
                      ...
                      <a class="" href="{{url('select-rooms')}}" >
                          <div class="card" >
                               <div class="img-rec">
                              <img src="{{asset('assets_frontend/images/recomment%20(3).jpg')}}" class="card-img-top" alt="...">
                              </div>
                              <div class="card-body">
                                  <p class="name-text">poolvilla</p>
                                  <p class="detail-text">cities , country</p>
                      ...
                      <a class="" href="{{url('select-rooms')}}" >
                          <div class="card" >
                               <div class="img-rec">
                              <img src="{{asset('assets_frontend/images/recomment%20(4).jpg')}}" class="card-img-top" alt="...">
                              </div>
                              <div class="card-body">
                                  <p class="name-text">poolvilla</p>
                                  <p class="detail-text">cities , country</p>
