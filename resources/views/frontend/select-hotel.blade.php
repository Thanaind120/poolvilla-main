    ...
    <div class="bg-orange-light2">
        <div class="row g-1">
            <div class="col-lg-2 col-12">
                <?php if(isset($c_from)) {?>
                <input class="form-control emptytwo orange" type="text" id="iconified" name="country_from"
                            ...
                            <div class="line-check-in">
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-10">
                                        ...
                                        <input type="date" class="form-control orange-check check-in-out" id="check-in"
                                            value="{{ $cin_from }}">
                                        <?php }else{ ?>
                                        <input type="date" class="form-control orange-check check-in-out" id="check-in"
                                            value="">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-4">
                                    <div class="row g-2">
                                        ...
                                        <div class="col-auto">
                                            <?php if(isset($r_from)) {?>
                                            <input class="input-number" id=demoInput type=number min=1 max=110
                                                placeholder="1" value="{{ $r_from }}">
                                            <?php }else if(isset($ro)) { ?>
                                            <input class="input-number" id=demoInput type=number min=1 max=110
                                                placeholder="1" value="{{ $ro }}">
                                            <?php }else{ ?>
                                            <input class="input-number" id=demoInput type=number min=1 max=110
                                                placeholder="1" value="">
                                            <?php } ?>
                                                        ...
                                                        <fieldset class="filter-price">
                                                            <div class="price-field">
                                                                <input type="range" min="0" max="10000" value="0"
                                                                    id="lower">
                                                                <input type="range" min="100" max="10000" value="10000"
                                                                    id="upper">
                                                            </div>
                                                            <div class="price-wrap">
                                                                <div class="price-container">
                            ...
                            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a class="bread"
                                            href="{{url('select-hotel')}}">*country*</a></li>
