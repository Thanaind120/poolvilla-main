    ...
    <div class="container">
        <div class="box-hotel">
                ...
                <div class="mt-3">
                    ...
                    <div class="col-xl-6">
                        <div class="vl-filter-hotel">
                            <div class="mt-3">
                            <div class="clearfix">
                            <div class="float-start"><div class="text-tiny text-grey text-bold">Price per group size</div></div>
                            <div class="float-end">
                                <a href="edit_property11-1.php">
                        ...
                        <div class="vl-filter-hotel">
                            <div class="mt-3">
                                <div class="clearfix">
                                    <div class="float-start"><div class="text-tiny text-grey text-bold">Cancellation policy</div></div>
                                    <div class="float-end">
                                    <a href="edit_property11-2.php">
                                        <div class="text-tiny text-red text-bold"><i class="fas fa-pencil-alt me-2"></i>Edit</div>
                                    </a>
                                </div>
                                </div>
                ...
                <div class="mt-5">
                    ...
                    <div class="col-xl-6">
                        <div class="vl-filter-hotel">
                            <div class="mt-3">
                                <div class="clearfix">
                                    <div class="float-start"><div class="text-tiny text-grey text-bold">Price and cancellation policy</div></div>
                                    <div class="float-end">
                                        <a href="edit_property11-3.php">
                                            <div class="text-tiny text-red text-bold"><i class="fas fa-pencil-alt me-2"></i>Edit</div>
                                        </a>
                                    </div>
                                </div>
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-sm-4 ">
                     <a href="list_property10.php"><div class="btn-grey mt-3">Back</div></a>
                </div>
                <div class="col-sm-4 ">
                    <a href="list_property12.php"><div class="btn-orange mt-3">Next</div></a>
                </div>
            </div>
        </div>
    </div>
