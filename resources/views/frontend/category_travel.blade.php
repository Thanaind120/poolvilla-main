            ...
            <div class="float-start">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a class="bread" href="category.php">Catergory</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Beach</li>
                    </ol>
                </nav>  
            </div>
        </div>
        ...
        <div class="row mt-3">
            <div class="col-sm-3  none-mobile">
                ...
                <div class="mt-4">
                     <div class="vl-filter">
                    <div class="dropdown ">
                    <button class="dropdown-toggle btn-category text-filter" type="button" data-toggle="dropdown"><i class="fas fa-globe-asia me-2"></i>Country
            ...
            <div class="col-sm-9">
                <div class="head-text-index">Enjoy with *Beach*</div>
