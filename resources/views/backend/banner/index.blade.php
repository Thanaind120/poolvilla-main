      ...
      <section class="section">
        ...
        <div class="section-body">
          ...
          <div class="text-right">
            ...
            <a class="btn btn-success" href="{{url('backend/banner/add')}}"><i class="fa fa-image"></i> add</a>
          </div><br>
            </div>
            <div class="card-body ">
...
<td class="text-center"><img src="{{asset('frontend_assets/banner/'.$b->banner_image)}}" width="250px" height="100px" class="mt-1"></td>
                  
                    <td class="text-center">
                      <!-- <button class="btn btn-warning" data-toggle="modal" data-target="#edit_banner" onclick="edit_banner('{{$b->id}}')">Edit</button> -->
                      <a class="btn btn-warning" href="{{url('backend/banner/edit/'.$b->id)}}">Edit</a>
                      <button class="btn btn-danger" onclick="confirm_delete('{{$b->id}}')">Delete</button>
                    </td>                
                  </tr>
...
<div class="modal fade" id="add_banner" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
      ...
      <form class="was-validated" method="POST" action="{{ url('backend/banner/save') }}"  enctype="multipart/form-data">
                 @csrf
...
<div class="modal fade" id="edit_banner" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
      <div class="modal-content">
      <form class="was-validated" method="POST" action="{{ url('backend/banner/update') }}"  enctype="multipart/form-data">
                 @csrf
          <div class="modal-header">
