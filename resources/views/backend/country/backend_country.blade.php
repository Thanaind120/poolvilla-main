                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <div class="text-right">
                                    <a href="{{url('backend/country/add')}}" class="btn btn-success "><i
                                    ...
                                    <table id="simpletable" class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                @if($check->page_edit == 1 || $check->page_view == 1 ||
                                                $check->page_delete == 1)
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 35%">
                                                    <img src="{{ asset('frontend_assets/country_image/'.$row->country_image) }}"
                                                        height="150px" alt="">
                                                </td>
                                                @if($check->page_edit == 1 || $check->page_view == 1 ||
                                                $check->page_delete == 1)
                                                <td style="width: 20%">
                                                    ...
                                                    <a class="btn btn-warning text-white"
                                                        href="{{url('backend/country/edit/'.$row->country_id)}}"><i
                                                    ...
                                                    <a class="btn btn-info text-white"
                                                        href="{{url('backend/country/city/'.$row->country_id)}}"><i
                                                            class="fa fa-pencil-square-o"></i> City</a>
                                                    @endif
                                                </td>
                                                @endif
                                            </tr>
