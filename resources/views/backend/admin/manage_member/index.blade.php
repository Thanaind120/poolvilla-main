      ...
      <section class="section">
        ...
        <div class="section-body">
          ...
          <div class="text-right">
            <a href="{{url('backend/admin/add-member')}}" class="btn btn-success "><i class="fa fa-plus"></i> add</a>
          </div><br>
            </div>
            <div class="card-body ">
              <div class="table-responsive">
                ...
                <tbody>
                  ...
                  <td>{{$u->name}}</td>
                    ...
                    <td>
                    <a class="btn btn-warning text-white" href="{{url('backend/admin/update_member/'.$u->id)}}"><i class="fa fa-pencil-square-o"></i> Edit</a>
                    </td>
                  </tr>
                    @endforeach
                </tbody>
