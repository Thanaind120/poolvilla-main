      ...
      <section class="section">
        ...
        <div class="section-body">
          ...
          <div class="text-right">
            <a href="{{url('backend/admin/add-hotel')}}" class="btn btn-success "><i class="fa fa-plus"></i> add</a>
          </div><br>
            </div>
            <div class="card-body ">
              <div class="table-responsive">
                ...
                <tbody>
                  ...
                  <td>{{$u->firstname}} {{$u->lastname}}</td>
                    ...
                    <td class="text-center">
                    <a class="btn btn-warning text-white" href="{{url('backend/admin/update_hotel/'.$u->id)}}"> Edit <i class="fa fa-user"></i></a>
