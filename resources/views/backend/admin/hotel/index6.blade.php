...
<body>
  <div id="app">
      ...
      <section class="section">
        ...
        <div class="section-body">
          ...
          <div class="card">             
            ...
            <div class="card-body ">
              <div class="form-group row ml-4 mt-5">           
                ...
                <div class="col-md-8">
                    <input class="form-control" type="text" value="Korn Pakorn" name="name" readonly>
                </div>
            </div>
              ...
              <div class="form-group row ml-4 mt-5">           
                ...
                <div class="col-md-8">
                    <input class="form-control" type="text" value="pakorn@ots.co.th" name="name" readonly>
                </div>   
            </div>
            ...
            <div class="form-group row ml-4 mt-5">           
              ...
              <div class="col-md-8">
                  <input class="form-control" type="text" value="0648106281" name="name" readonly>
              </div>   
          </div>
          ...
          <div class="form-group row ml-4 mt-5">           
            ...
            <div class="col-md-8">
                <input class="form-control" type="date" value="2021-12-28" name="name" readonly>
            </div>   
        </div>
    ...
    <div class="form-group row ml-4 mt-5">           
      ...
      <div class="col-md-8">
          <input class="form-control" type="number" value="3500" name="name" readonly>
