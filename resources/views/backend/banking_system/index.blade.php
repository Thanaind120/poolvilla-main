      ...
      <section class="section">
        ...
        <div class="section-body">
          ...
          <div class="text-right">
            <a href="{{url('backend/admin/add_bank_system')}}" class="btn btn-success "><i class="fa fa-plus"></i> add</a>
          </div><br>
            </div>
            <div class="card-body ">
              <div class="table-responsive">
                ...
                <thead>
                  <tr>
                    ...
                    <th scope="col"><i class="fa fa-user text-center"></i>Acoount Number</th>
                ...
                <tbody>
                  ...
                  <td class="text-center"><img src="{{asset($u->logo)}}" width="120px" height="120px"></td>
                    ...
                    <a class="btn btn-warning text-white" href="{{url('backend/admin/update_bank_system/'.$u->id)}}"> Edit <i class="fa fa-user"></i></a>
